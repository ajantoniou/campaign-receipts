  ...
  return (
    <html lang="en" className={`${instrumentSerif.variable} ${GeistSans.variable} ${GeistMono.variable}`}>
      <body className="font-sans antialiased bg-paper text-ink selection:bg-partial-bg selection:text-ink">
          ...
          <div className="section-shell">
            <div className="h-16 sm:h-18 flex items-center justify-between gap-2 sm:gap-4">
              ...
              <nav className="hidden lg:flex items-center gap-0.5 min-w-0" aria-label="Primary">
                ...
                <Link href="/betting" className="font-sans text-[13px] text-ink-2 hover:text-ink px-2.5 py-3 -my-1 rounded-md transition-colors border-b border-transparent hover:border-ink">
                  Alpha Terminal
                </Link>
        ...
        {/* Cloudflare Web Analytics — proxied via first-party to bypass blockers. */}
        <Script
          src="/ingest/cf-beacon.js"
          data-cf-beacon={`{"token": "${CF_ANALYTICS_TOKEN}", "send": "/ingest/cf-beacon"}`}
