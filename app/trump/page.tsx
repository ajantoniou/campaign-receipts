...
export const metadata = {
  ...
  description:
    '145 campaign promises from the 2016 cycle, graded against the 2017-2021 term. From the SEALED Press book — receipts on every verdict.',
}
      ...
      <section className="border-b border-parchment-200">
        <div className="section-shell pt-16 pb-10">
          <div className="text-[11px] uppercase tracking-[0.18em] font-semibold text-authority-600 mb-3">
            From the SEALED Press book · 2016 cycle
          </div>
          ...
          <p className="mt-5 text-lg text-ink-700 max-w-3xl leading-relaxed font-editorial">
            ...
            verdict here links to the book chapter and its primary-source receipts.
          </p>
          <p className="mt-4 text-[15px] text-ink-700 max-w-3xl leading-relaxed font-editorial">
            The 145 promises below come from <em>SEALED</em> — the published book that graded all of
            them, plus 52 preserved commitments from the deleted 2024 platform. Read the full book:{' '}
            <a
              href="https://sealed2016.com/?utm_source=campaignreceipts&utm_medium=cross-link&utm_content=trump-dashboard"
              target="_blank"
              rel="noopener"
          ...
          {/* Scorecard tiles — book-canonical totals */}
