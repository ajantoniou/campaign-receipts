  ...
  return (
    <>
      ...
      <section className="section-shell pb-12">
        <p className="max-w-2xl text-xs text-ink-500 leading-relaxed">
          Want the full donor-to-vote paper trail in book form?{' '}
          <a
            href={`https://sealed2016.com/?utm_source=campaignreceipts&utm_medium=cross-link&utm_content=politician-${p.slug}-correlations`}
            target="_blank"
            rel="noopener noreferrer"
            className="text-authority-300 underline underline-offset-4 hover:underline"
          >
