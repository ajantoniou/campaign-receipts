...
export default async function DonorsPage({
  ...
  return (
    <>
      ...
      {/* Quiet SEALED cross-link — deep-funnel surface, single link only. */}
      <section className="section-shell pb-12">
        <p className="max-w-2xl text-xs text-ink-3 leading-relaxed">
          Want the donor-money-to-broken-promise paper trail in one place?{' '}
          <a
            href={`https://sealed2016.com/?utm_source=campaignreceipts&utm_medium=cross-link&utm_content=politician-${politician.slug}-donors`}
            target="_blank"
            rel="noopener noreferrer"
            className="text-authority-700 underline underline-offset-4 hover:underline"
          >
            Read the SEALED book →
          </a>
        </p>
      </section>
    </>
