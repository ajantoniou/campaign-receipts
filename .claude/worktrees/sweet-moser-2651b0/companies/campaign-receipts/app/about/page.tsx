        ...
        <div className="max-w-[760px] mx-auto">
          ...
          <div className="mt-10 rounded-lg border border-line bg-paper p-6">
            ...
            <div className="mt-1 font-mono text-[11px] uppercase tracking-[0.14em] text-ink-2">
              Founder · SEALED Press
            </div>
            <p className="mt-3 font-sans text-[15px] text-ink-2 leading-relaxed">
              Founded SEALED Press in 2025 to publish primary-source political audits.
              Author of <em className="font-display">SEALED — The 2016 Promises</em>, a 145-promise
              fact-check of the Trump 2016 campaign with paper-trail receipts on every claim.
      ...
      <section className="section-shell py-14 sm:py-20 bg-paper-2">
        <div className="max-w-[760px] mx-auto">
          ...
          <p className="mt-4 font-sans text-[15px] text-ink-2 leading-relaxed max-w-2xl">
            All {BOOK.totalPromises} of Donald Trump's 2016 campaign promises, fact-checked with
            paper-trail receipts on every claim. The methodology applied to the full SEALED corpus —
            the same methodology CampaignReceipts now applies to every politician at scale.
            {BOOK.pages}-page watermarked PDF.
          </p>
          <div className="mt-6 flex flex-wrap items-center gap-3">
            ...
            >
              Read the case study — {BOOK.pdfPrice}
