      ...
      <section className="border-b border-parchment-200">
        <div className="section-shell pt-20 pb-12">
          ...
          <p className="mt-4 text-[14px] text-ink-700 max-w-2xl leading-relaxed">
            Citation archive — every primary source linked from <em>SEALED</em>, the published
            book that graded Trump's 2016 promises against the 2017–2021 record.{' '}
            <a
              href="https://sealed2016.com/?utm_source=campaignreceipts&utm_medium=cross-link&utm_content=sources"
              target="_blank"
              rel="noopener"
      ...
      <section>
        <div className="section-shell py-12">
          ...
          <p className="mt-12 text-sm text-ink-600 leading-relaxed max-w-2xl">
            ...
            <a href="mailto:support@sealed2016.com" className="text-authority-600 hover:text-authority-700 underline-offset-4 hover:underline font-medium">
              tell us
            </a>{' '}
