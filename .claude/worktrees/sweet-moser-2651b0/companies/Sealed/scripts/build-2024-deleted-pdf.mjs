 ...
 *
 * Output: public/pdfs/2024-deleted-promises-v1.pdf
...
const OUTPUT_PDF = path.join(ROOT, "public", "pdfs", "2024-deleted-promises-v1.pdf");
const OUTPUT_HTML = path.join(ROOT, "public", "pdfs", "2024-deleted-promises-v1.html");
