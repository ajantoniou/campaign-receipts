...
export default async function SealedPage() {
  ...
  // 2026-05-25 founder lock: PDF $15 SKU removed from the landing page.
  // Hero CTA = paperback only ($25). 2024 Deleted Promises ($5 PDF) is
  // teased below the paperback as a coming-soon stepping-stone.
    ...
    <main className="min-h-screen bg-parchment-100 text-ink-900">
          ...
          <div className="mt-10 grid items-center gap-10 lg:grid-cols-[minmax(0,480px)_minmax(0,1fr)] lg:gap-14">
            ...
            <div>
              ...
              <div className="mt-8 flex flex-col items-center gap-3 lg:items-start">
                ...
                {/* 2026-05-25: $5 "2024 Deleted Promises" stepping-stone PDF
                    teased as coming-soon. Three verbatim 2024 platform
                    promises that were pulled from donaldjtrump.com on
                    Jan 20 2025 and then contradicted by 2025 actions. */}
                <p className="mt-2 max-w-md text-center text-xs leading-relaxed text-ink-600 lg:text-left">
                  Coming soon &mdash; <span className="font-semibold text-civic-blue">2024 Deleted Promises ($5 PDF)</span>:
                  four platform pages he pulled from donaldjtrump.com on
                  Jan&nbsp;20, 2025 &mdash; including &ldquo;prevent world war three,&rdquo;
                  &ldquo;keep America out of unnecessary foreign wars,&rdquo;
                  &ldquo;end inflation, make America affordable again,&rdquo; and
                  &ldquo;end the weaponization of government against the American people.&rdquo;
                  Receipts on each.
                </p>
              </div>
            </div>
      ...
      <section className="border-b border-ink-900/10 bg-parchment-100">
        <div className="mx-auto max-w-5xl px-6 py-10 lg:py-20">
          <p className="sealed-eyebrow">{sampleReceipt.eyebrow}s</p>
      ...
      {/* 2026-05-25: dashboardHref/bundleHref removed from page — the Dashboard
          and Book ($15) cards inside ThreeWaysIn were deleted. Props kept
          optional on the component for backward compat. */}
