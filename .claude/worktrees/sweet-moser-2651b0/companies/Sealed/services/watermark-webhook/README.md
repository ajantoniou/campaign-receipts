# SEALED Watermark Webhook — RETIRED 2026-05-25

> **🚫 RETIRED.** This service is no longer in use.
>
> **Why:** SEALED 2016 $15 PDF SKU retired. The LS variant was repurposed as
> the **2024 Deleted Promises $5 PDF**, which is uploaded directly to Lemon
> Squeezy as a "file delivery" product (no watermarking needed for a $5
> companion PDF). Paperback ($25) goes directly to lulu.com and never touched
> this service. Founder lock 2026-05-25.
>
> **Render service:** suspended/deleted (founder action in Render dashboard).
> **LS webhook:** the `order_created` URL pointing here was removed in the LS
> dashboard. New orders no longer hit this endpoint.
>
> **To resurrect:** code is intact. Re-deploy, re-set env vars (`SUPABASE_URL`,
> `SUPABASE_SERVICE_ROLE_KEY`, `SUPABASE_BUCKET`, `LEMONSQUEEZY_WEBHOOK_SECRET`,
> `RESEND_API_KEY`, optional `LULU_*` + `LEMONSQUEEZY_PAPERBACK_VARIANT_ID`),
> re-add LS webhook URL.

---

## (Historical) SEALED Watermark Webhook
