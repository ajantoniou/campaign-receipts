...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const productData = await createOrGetProduct(
      ...
      2200, // $22.00 in cents
      'A historical archive of Trump\'s 2015-2016 campaign promises. PDF + ePub included at purchase; audiobook files unlock on the same Lemon Squeezy order when mastering completes.'
    )
