...
> ⚠️ **This folder is NOT deployed.** sealed2016.com is served by Render
> service `sealed-press` (srv-d7rub9pkh4rs73f2dbd0), which builds from
> `companies/concise-sealed` on `main`. Any site change made here must also
> land in `companies/concise-sealed/` (keep `app/`, `lib/`, `components/`
> identical) or it never reaches production — that's how the retired $15
> price survived on the live site until 2026-06-11.
