...
// donor-influence product, NOT promises. Trump's 2016 audit is included
// free here too (the SEALED book paywall was removed 2026-06-14).
//
...
async function getData(page: number, filterDb: string | null, q: string) {
  let query = supabaseService
    ...
    // Graded promises only. (Trump's 2016 audit is now free and included here;
    // the 2024 record has no verdicts yet, so it's excluded by this filter.)
    .not('verdict', 'is', null)
