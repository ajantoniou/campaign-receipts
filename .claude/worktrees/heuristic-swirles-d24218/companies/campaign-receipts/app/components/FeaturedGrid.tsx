      ...
      <div className="mb-8 flex items-end justify-between flex-wrap gap-4">
        <div>
          ...
          <p className="mt-3 text-ink-400 text-[15px] max-w-2xl">
            Twelve politicians chosen to span the full range — completed-term graded scorecards, in-progress live tracking, leadership figures, partisan flanks, and the 2016 Trump audit&rsquo;s case-study record.
          </p>
        </div>
