...
const ITEMS: Item[] = [
  // Engine-first primary group (matches the 4-item desktop nav).
  { href: '/', label: 'Search' },
  { href: '/leaderboard', label: 'Explore' },
  { href: '/pricing', label: 'Pricing' },
  // Secondary — the SEO + investigation surfaces, still reachable.
  { href: '/race', label: 'The big races', tag: 'live', muted: true },
  { href: '/articles', label: 'Articles', muted: true },
  { href: '/bills', label: 'Friday Receipts (newsletter)', muted: true },
  { href: '/who-funds/pro-israel', label: 'Who took pro-Israel money', muted: true },
  { href: '/for-journalists', label: 'For journalists', muted: true },
