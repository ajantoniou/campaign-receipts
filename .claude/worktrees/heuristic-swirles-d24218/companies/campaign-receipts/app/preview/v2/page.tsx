      ...
      <section className="border-b border-line">
        <div className="section-shell py-section-y">
          ...
          <p className="font-sans text-sm text-ink-3 mt-4 max-w-2xl leading-relaxed italic">
            Editorial lead: <span className="not-italic text-ink-2 font-medium">Alex Antoniou</span>. No party affiliation, no campaign-staff history. Conservative + progressive reviewer panels rotate; their notes are stored as a public audit trail.
          </p>
