...
// Renders the 9 chapter overviews + canonical totals.
...
function pdfHtml() {
  ...
  * { box-sizing: border-box; }
  ...
  <div class="page">
    <div class="eyebrow">2016 cycle audit</div>
    ...
    <div class="footer">
      ...
      <div class="disclosure">82% of 2016 promises link to a primary source; the remaining 18% link to two independent contemporaneous reports.</div>
    </div>
  </div>
  </body></html>`
}
