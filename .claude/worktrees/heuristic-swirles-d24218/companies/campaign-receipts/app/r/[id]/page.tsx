            ...
            <div className="max-w-prose">
              ...
              {isAnchor ? (
                <div className="space-y-4 font-sans text-[15px] sm:text-[16px] text-ink-2 leading-[1.6]">
                  ...
                  <p>
                    The 2016 Trump audit grades what Trump promised the
                    country before any of this money flowed. 145 campaign
                    promises, graded against primary-source receipts. It is
                    free on-site.
                  </p>
                  <Link
