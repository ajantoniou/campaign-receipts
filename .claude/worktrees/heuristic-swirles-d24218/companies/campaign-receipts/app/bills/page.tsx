...
// $9/mo FLAT for everything — ALL federal AND state bills, one price.
...
// real checkout: /api/checkout?product=newsletter ($9/mo, LemonSqueezy).
//
...
// occasional free updates. The headline is always the $9 paid weekly.
        ...
        <div className="section-shell pt-12 pb-10 sm:pt-16 sm:pb-12">
          <div className="max-w-3xl">
            ...
            <p className="mt-3 font-sans text-[15px] text-ink-3 leading-relaxed max-w-2xl">
              ...
              bills, federal and state. $9 a month. Cancel anytime.
            </p>
      ...
      <section id="price" className="section-shell py-12 sm:py-16 bg-paper-2 scroll-mt-20">
        <div className="max-w-[760px] mx-auto text-center">
          ...
          <p className="mt-4 font-sans text-[17px] text-ink-2 leading-relaxed">
            $9 a month. All federal bills. All 50 states. Cancel anytime.
          </p>
          <div className="mt-7">
            <a
              href="/api/checkout?product=newsletter"
      ...
      <section id="free" className="section-shell py-12 sm:py-16 scroll-mt-20">
        <div className="max-w-[760px] mx-auto">
          <NewsletterCapture
            ...
            body="We send occasional free updates. Want a bill every Friday with the money behind it? That is Friday Receipts above ($9)."
