...
//   2. FRIDAY RECEIPTS — $9/mo — the weekly Friday money-trail email.
...
export const metadata = {
  ...
  description:
    'Read every record free. Get the weekly money trail in your inbox for $9 a month. Or search any donor, bill, or vote and pull a sourced dossier for $45 a month.',
}
  ...
  return (
    <section className="bg-paper">
      <div className="section-shell py-16 sm:py-24">
        ...
        <Reveal className="mt-10 grid gap-6 lg:grid-cols-3 max-w-[1080px] items-stretch">
          {/* ─── Column 1 — FREE ─────────────────────────── */}
          ...
          <div className="rounded-lg border border-line bg-paper p-6 flex flex-col">
            ...
            <div className="mt-2 font-display text-[20px] text-ink">
              $9 <span className="font-sans text-[14px] text-ink-3">/ month</span>
            </div>
            <p className="mt-3 font-sans text-[15px] text-ink-2 leading-[1.55]">
