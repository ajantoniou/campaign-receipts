...
export const sampleReceipt = {
  ...
  closing:
    'Three campaign promises broken. Three donor wishes granted. One chapter, one funder. 142 more receipts in the book.',
} as const
...
/* 2026-06-11: heroCredibilityBullets, heroStatBar, and productPreviewCards
 * deleted — they were only rendered by the retired landing-blocks.tsx and
 * described the retired watermarked-PDF / ePub / toolkit-tier offer. */
...
export const faqItems = [
  {
    q: 'What is SEALED?',
    a: 'A book that preserves 145 of Donald Trump’s 2015–2016 campaign promises — verbatim, sourced, and dated — and pairs each one with the official filings, votes, and documents that show what actually happened. We grade every promise against the record (46 kept · 51 partial · 40 broken · 8 reader-decides) and we show every receipt so you can dispute our calls. No pundit middle layer. Editorial verdicts in plain sight, with the paper trail next to them.',
  },
  {
    q: 'Is this partisan?',
